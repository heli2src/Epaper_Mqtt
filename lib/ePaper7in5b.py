...
# heli2src (Christian Jung):
#     improve startup behavior. Sometime after powerup there is no ready signal, then a startup is started again after 60s.

# -----------------------------------------------------------------------------
# * | File        :	  ePaper7in5b.py
# * | Author      :   Waveshare team/Christian Jung
...
class EPD(framebuf.FrameBuffer):
    ...
    def __init__(self, spi, cs, dc, rst, busy, landscape=False, asyn=False):
        ...
        self.mvb = memoryview(self._buffer)
    ...
    def init(self):
        ...
        while wait_for_ready:
            ...
            sleep_ms(100)
            wait_for_ready = not self.wait_until_ready()
    ...
    def wait_until_ready(self):
        ...
        while not self.ready():  
            sleep_ms(100)
            if  ticks_diff(ticks_ms(), t) > 60000:          #max time ~27s, sometime after powerup there is no ready signal
                return False
