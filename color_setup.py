...
from lib.ePaper7in5b import EPD as SSD
from lib.ePaper7in5b import EPDred as SSDred
...
landscape = False
ssd = SSD(spi, pcs, pdc, prst, pbusy, landscape=landscape, asyn=False)  # Create a display instance
ssdred = SSDred(spi, pcs, pdc, prst, pbusy, landscape=landscape)  # Cread a red display instance (just for B model)
ssd.demo_mode = False
